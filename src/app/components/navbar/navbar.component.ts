  ...
  template: `
    <nav class="fixed top-0 left-0 right-0 z-50 transition-all duration-300"
      ...
      <div class="container-custom">
        <div class="flex items-center justify-between h-20">
          ...
          <a routerLink="/" class="flex items-center space-x-3 group">
            <div class="w-12 h-12 bg-assurantis-red rounded-xl flex items-center justify-center 
          ...
          <div class="hidden lg:flex items-center space-x-8">
            <a routerLink="/" routerLinkActive="text-assurantis-red" 
               [routerLinkActiveOptions]="{exact: true}"
               class="text-assurantis-grayDark hover:text-assurantis-red transition-colors duration-200 font-medium">
              Accueil
            </a>
            <a routerLink="/services" routerLinkActive="text-assurantis-red"
               class="text-assurantis-grayDark hover:text-assurantis-red transition-colors duration-200 font-medium">
              Nos Services
            </a>
            <a routerLink="/a-propos" routerLinkActive="text-assurantis-red"
               class="text-assurantis-grayDark hover:text-assurantis-red transition-colors duration-200 font-medium">
              À Propos
            </a>
            <a routerLink="/contact" routerLinkActive="text-assurantis-red"
               class="text-assurantis-grayDark hover:text-assurantis-red transition-colors duration-200 font-medium">
              Contact
            </a>
          </div>
          ...
          <button (click)="toggleMobileMenu()" 
                  class="lg:hidden p-2 text-assurantis-grayDark hover:text-assurantis-red transition-colors"
      ...
      <div *ngIf="mobileMenuOpen" 
           class="lg:hidden bg-white border-t border-assurantis-grayLight animate-fade-in">
        <div class="container-custom py-6 space-y-4">
          <a routerLink="/" (click)="closeMobileMenu()"
             routerLinkActive="text-assurantis-red bg-assurantis-grayLighter"
             [routerLinkActiveOptions]="{exact: true}"
             class="block px-4 py-3 rounded-xl hover:bg-assurantis-grayLighter transition-colors font-medium">
            Accueil
          </a>
          ...
          <div class="pt-4 border-t border-assurantis-grayLight space-y-3">
            ...
            <a routerLink="/devis" (click)="closeMobileMenu()"
